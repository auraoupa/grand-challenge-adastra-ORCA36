...
| Conf   | Exp  | Init         | Atm F | Dt   | Icav| zlev   | Ice init | Runoffs  | Debug options           | Result |
| -------|------|--------------|-------|------|-----|--------|----------|----------|-------------------------|--------|
...
|AAi001  |EXP03c| WOA          | JRA55 | 600  | No  | 75_4.2 | from SST | ISBA JMM | None                    | OK |
|AAi001  |EXP04 | WOA          | ERA5  | 600  | No  | 75_4.2 | from SST | ISBA JMM | None                    | OK |
|AAi001  |EXP05 | WOA          | ERA5  | 600  | No  | 75_4.2 | from SST | ISBA AA  | None                    | OK |
|AAi001  |EXP06 | MP026        | ERA5  | 600  | No  | 75_4.2 | from SST | ISBA AA  | None                    | segmentation fault at kt=2 |
|AAi001d |EXP06 | MP026        | ERA5  | 600  | No  | 75_4.2 | from SST | ISBA AA  | -g  -CB -traceback      | Subscript #2 of the array RKRGB has value -2147483648 which is less than the lower bound of 1 in traqsr.f90 |
|AAi001  |EXP07 | WOA          | ERA5  | 600  | No  | 121_4.2| from SST | ISBA AA  | None                    | OK |
|AAi001  |EXP08 | MP026        | ERA5  | 600  | No  | 121_4.2| from SST | ISBA AA  | None                    | |
